<div class="my_meta_control" id="expenseinfo">

<table class="form-table">
	<tr>
		<th scope="row"><label><?php _e('Date', 'wpaesm'); ?></label></th>
		<td>
			<input id="thisdate" class="required" type="text" size="10" name="<?php $metabox->the_name('date'); ?>" value="<?php $metabox->the_value('date'); ?>"/>
		</td>
	</tr>
